<template>
    <div class="chart-fill">
        <apexchart type="bubble" height="100%" :options="options" :series="resolvedSeries" />
    </div>
</template>
...
const props = defineProps({
    series: { type: Array, default: () => [] }, // [{name, data:[{x,y,z}, ...]}]
...
const options = computed(() => {
    ...
    return {
        ...
        colors: palette,
        xaxis: { title: { text: props.xTitle || undefined } },
